...
export const metadata: Metadata = {
  ...
  description:
    "Kitchens & Bathrooms by DiFiore Builders — smart layouts, durable materials, beautiful details. Cabinets, tile & stone, plumbing & electrical, lighting, and more.",
      ...
      <section className="px-4 py-12 md:py-16">
        <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-[1.15fr_.85fr]">
          ...
          <figure className="grid grid-cols-2 gap-4 self-start">
            <img
              src="/difiore-services-showcase-kitchen-closeup.webp"
          ...
          <div className="rvv-bubble rounded-2xl border border-[rgba(255,255,255,.14)] bg-[rgba(12,15,20,.85)] shadow-[0_24px_60px_rgba(2,8,18,.45)]">
            <div className="rvv-surface p-5 md:p-6">
              ...
              <p className="mt-2 text-[15px] text-zinc-100">
                “DiFiore rebuilt our kitchen and primary bath. Communication was excellent, the crew was
                respectful, and the results speak for themselves. We’d hire them again without hesitation.”
              </p>
            </div>
          </div>
