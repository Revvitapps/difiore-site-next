...
export default function TrustedBadges() {
  return (
    <section aria-label="Trusted & Verified" className="px-4 py-12 md:py-16">
          ...
          >
            <div className="grid grid-cols-[220px_1fr] items-center gap-4">
              <div className="grid place-items-center">
                <img
                  src="https://m.bbb.org/terminuscontent/dist/img/business-profile/accreditation/AB-seal-horz.svg?tx=f_svg,w_480"
                  alt="BBB Accredited Business"
                  className="h-24 w-auto"  /* was h-12/h-14 */
                  loading="lazy"
                />
              </div>
